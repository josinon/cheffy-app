...
* [`src/cheffy/`](src/cheffy/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cheffy/core.cljs): contains the SPA entry point, `init`
* [`test/cheffy/`](test/cheffy/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `cheffy` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cheffy/config.cljs) defaults to `true` in
...
```clj
(ns cheffy.example
  (:require [cheffy.config :as config])
